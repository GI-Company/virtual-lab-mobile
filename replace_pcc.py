...
# Find the start of processControlCommand
start_idx = content.find("suspend fun processControlCommand(command: BaseMessage, deviceId: String, sendResult: (String) -> Unit) {")
...
"""
    content = content[:start_idx] + new_process
